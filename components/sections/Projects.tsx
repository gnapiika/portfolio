...
const projects = [
  ...
  },
  {
    ...
    description:
      'A cyberpunk-themed hacking simulator game built with Unity. Players can experience a futuristic hacking environment, complete with challenges and missions that test their problem-solving skills and knowledge of cybersecurity concepts. This is in process of development and will be released soon.',
