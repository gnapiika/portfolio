...
const cards = [
  {
    icon: GraduationCap,
    title: 'Education',
    text: 'I am a 7th Semester Computer Science Engineering student passionate about solving real-world problems through technology. This includes a strong foundation in programming, algorithms, data structures, and software development principles with a focus on cybersecurity, artificial intelligence, data science, and full stack development. I am very eager to apply my knowledge and skills to contribute to innovative projects and make a positive impact in the field of technology.',
  },
  {
    icon: Shield,
    title: 'Cybersecurity',
    text: 'Interested in ethical hacking, digital forensics, network security, secure software engineering, and threat detection. I am very passionate about protecting systems and data from cyber threats, attacks and ensuring the security of applications and networks. I very much enjoy learning about the latest security trends, vulnerabilities, and best practices to stay ahead in the ever-evolving field of cybersecurity. I am very much committed to promoting a culture of security awareness and implementing robust security measures to safeguard digital assets and sensitive information.',
  },
  {
    icon: Brain,
    title: 'Artificial Intelligence',
    text: 'Building intelligent applications and many softwares using Machine Learning, Deep Learning, Computer Vision, and Data Science and exploring the potential of AI to solve all complex problems and improve decision-making processes. I am fascinated by the capabilities of AI and its applications in various domains, from healthcare to finance, and I am very eager to contribute to the development of innovative AI solutions. A strong foundation in mathematics, statistics, and programming is essential for understanding and implementing AI algorithms effectively.',
  },
  {
    icon: Code2,
    title: 'Full Stack Development',
    text: 'Creating fast, responsive and scalable web applications with modern technologies and beautiful user experiences. I enjoy working on both the front-end and the back-end aspects of web development, building robust and efficient applications that meet user needs. I am constantly learning new frameworks, libraries, and tools to enhance my skills and stay up-to-date with the latest trends in web development.',
  },
];
