...
const cards = [
  {
    icon: GraduationCap,
    title: 'Education',
    text: 'I am a 7th Semester Computer Science Engineering student passionate about solving real-world problems through technology. This includes a very strong foundation in programming, algorithms, data structures, and software development principles with a focus on cybersecurity, artificial intelligence, data science, and full stack development. I am very eager to apply my knowledge and skills to contribute to innovative projects and make a positive impact in the field of technology.',
  },
  {
    icon: Shield,
    title: 'Cybersecurity',
