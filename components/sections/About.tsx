...
const cards = [
  ...
  },
  {
    ...
    text: 'Building intelligent applications and softwares using Machine Learning, Deep Learning, Computer Vision, and Data Science and exploring the potential of AI to solve complex problems and improve decision-making processes. I am fascinated by the capabilities of AI and its applications in various domains, from healthcare to finance, and I am very eager to contribute to the development of innovative AI solutions. A strong foundation in mathematics, statistics, and programming is essential for understanding and implementing AI algorithms effectively.',
  },
  {
    icon: Code2,
    title: 'Full Stack Development',
    text: 'Creating fast, responsive and scalable web applications with modern technologies and beautiful user experiences. I enjoy working on both the front-end aspects and back-end aspects of web development, building robust and efficient applications that meet user needs. I am constantly learning new frameworks, libraries, and tools to enhance my skills and stay up-to-date with the latest trends in web development.',
  },
];
