...
const cards = [
  ...
  },
  {
    ...
    text: 'Creating fast, responsive and scalable web applications with more modern technologies and beautiful user experiences. I enjoy working on both the front-end and the back-end aspects of web development, building robust and efficient applications that meet user needs. I am constantly learning new frameworks, libraries, and tools to enhance my skills and stay up-to-date with the latest trends in web development.',
  },
];
